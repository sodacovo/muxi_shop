  ...
  <div class="search-page">
    ...
    <div class="search-filter">
      ...
      <el-radio-group v-model="orderBy" @change="handleOrderChange">
        <el-radio-button :label="1">销量优先</el-radio-button>
        <el-radio-button :label="2">价格优先</el-radio-button>
      </el-radio-group>
    </div>
    ...
    <div v-loading="loading" class="goods-grid">
      ...
      <el-empty v-if="!loading && goodsList.length === 0" description="未找到相关商品" />
    </div>
